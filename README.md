...
Яндекс Практикум. Спринт 6. Итоговый проект. Финальное обновление проекта Yatube v4: [hw04_tests](https://github.com/egorcoders/hw04_tests.git)
...
1. Клонировать репозиторий:
   ...
   ```python
   git clone https://github.com/egorcoders/hw05_final.git
   ```
